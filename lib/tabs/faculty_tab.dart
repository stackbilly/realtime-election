...
class FacultyTab extends StatelessWidget {
  const FacultyTab({super.key, required this.theme});
                    ...
                    children: [
                        ...
                        trailing: IconButton(
                          onPressed: (() => Navigator.of(context).push(
                              realtime.route(CategoryResults(
                                  categoryName: "Faculty of Business",
                                  theme: theme)))),
                          icon: const Icon(
                      ...
                      ListTile(
                        ...
                        trailing: IconButton(
                          onPressed: (() => Navigator.of(context).push(
                              realtime.route(CategoryResults(
                                  categoryName: "Faculty of Life Sciences",
                                  theme: theme)))),
                          icon: const Icon(
                            Icons.arrow_forward_ios,
                            size: 17,
                      ...
                      ListTile(
                        ...
                        trailing: IconButton(
                          onPressed: (() => Navigator.of(context).push(
                              realtime.route(CategoryResults(
                                  categoryName: "Faculty of Education",
                                  theme: theme)))),
                          icon: const Icon(
                            Icons.arrow_forward_ios,
                            size: 17,
              ...
              children: [
                  ...
                  ListTile(
                    ...
                    trailing: IconButton(
                      onPressed: (() => Navigator.of(context).push(
                          realtime.route(CategoryResults(
                              categoryName: "Faculty of Science & Engineering",
                              theme: theme)))),
                      icon: const Icon(
                        Icons.arrow_forward_ios,
                        size: 17,
